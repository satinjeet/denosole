/**
 * I Got this code generously from https://github.com/dmitriytat/keypress/tree/master.
 * 
 * Sorry, I had and will need to make a few tweaks to this code in order to use it for myself. But please see the link above for
 * the actual author of this code. 
 */

import { encode, decode } from "../utils/functions.ts";
